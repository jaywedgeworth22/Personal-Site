 ...
 *
 * Fail-closed means skip instrumentation when keys are missing or
 * partial — never fail the Vercel production build or SSR.  Preview of
 * the same code succeeds; production was throwing here and blocking
 * every subsequent production deploy.
 *
