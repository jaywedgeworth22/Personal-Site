...
## Completed
- **2026-08-25 — CURSOR — COMPLETED — Datadog logs + APM + RUM.**  PR #19.  Existing Datadog account.  Missing keys stay dark.  Replay off.  Sentry / PagerDuty unchanged.
...
- 2026-08-25 — CURSOR-BUGBOT: Datadog fail-closed no longer aborts Vercel Production.
