...
- 2026-08-25: Datadog logs + APM + RUM on the existing account.  Missing
  `DD_*` keys stay dark (log + skip) so Vercel Production can still ship.
  Replay off.  Sentry / PagerDuty unchanged.
